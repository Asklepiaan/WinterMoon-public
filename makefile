...
ppcflg:
	...
	$(eval UFLAGS = -O3 -funroll-loops -flto -pg -g0)
	$(eval LUAFLAGS = -s -o)
	$(eval HOSTARCH = ppc)
...
macos:
	...
	-o $(EXECUTABLE)-a12 \
	-DUSE_MACOS_PLATFORM -DUSE_MACOS_WINDOW -DUSE_MACOS_PNG -DUSE_MACOS_MIXER -DUSE_MACOS_FONT -DUSE_LIB_RUBY \
...
macosppc:
	...
	main.cpp quartz_window.mm ScriptEngine.cpp \
	-o $(EXECUTABLE)-ppc \
	-DUSE_MACOS_PLATFORM -DUSE_QUARTZ_WINDOW -DUSE_MACOS_PNG -DUSE_QUARTZ_AUDIO -DUSE_QUARTZ_FONT -DUSE_LIB_RUBY \
	...
	-framework Quartz -framework Carbon
